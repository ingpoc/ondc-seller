...
export const COMMERCE_DEMO_MODE = import.meta.env.DEV && (
  COMMERCE_DEMO_MODE_OVERRIDE === 'true' ||
  (COMMERCE_DEMO_MODE_OVERRIDE !== 'false' && LOCAL_COMMERCE_BACKEND_RE.test(RAW_COMMERCE_API_BASE))
);
